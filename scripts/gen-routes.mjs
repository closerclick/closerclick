...
// como en /que-es (URL limpia), así la vista "¿Qué es CloserClick?" es enlazable
// e indexable de verdad (no un fallback 404). La app, al arrancar, deriva la
// vista inicial de location.pathname (ver src/App.vue) y closer-click-nav
...
const ORIGIN = 'https://closer.click'
...
const routes = [
  {
    ...
    title: '¿Qué es CloserClick? — Filosofía y arquitectura',
    ogTitle: '¿Qué es CloserClick?',
    description:
      'Qué es CloserClick: un ecosistema de apps autohosteadas que comparten identidad, transporte y almacenamiento. Tu información, en tu servidor, bajo tus reglas.',
  },
]
