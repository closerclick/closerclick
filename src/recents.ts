/* Lista de "Recientes" del hub.
   ...
   compartido <closer-click-support> (montado en CADA app del ecosistema) en el
   store COMPARTIDO store.closer.click. Aquí el hub solo LEE ese agregado.
   ...
   Ver @closerclick/closer-click-support (recordAppOpen) y
   @closerclick/closer-click-store (recordOpen/getOpens). */
...
// claves son ids de app = hostname (p. ej. "mundial.closer.click").
