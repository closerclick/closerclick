...
/* ---------------- Vistas: home (apps) ↔ "¿Qué es CloserClick?" ----------------
   ...
   enlazable e indexable; `aboutOpen` se registra como capa de closer-click-nav
...
/* ---------------- Mi perfil (Web Component compartido) ----------------
   Abre <closer-click-profile> en modo edición con mi identidad del vault
   id.closer.click. Es el MISMO perfil que en el resto del ecosistema. */
...
/* ---------------- Volver unificado (@closerclick/closer-click-nav) ----------------
   El botón físico / chevron cierra el modal de info o el menú móvil, luego la
   vista "¿Qué es CloserClick?" (vuelve a la página de apps), y solo después
   abandona el sitio. */
...
// closer.click es el root del ecosistema: el chevron solo aparece cuando hay
...
/* ---------------- Navegación entre vistas ----------------
   ...
   al volver a home con una capa abierta, closer-click-nav restaura la URL solo.
...
<style scoped>
/* ─────────────────────────────────────────────────────────────────────────
   Closer Click — cáscara. Estética "panel soberano": tinta profunda + acento
